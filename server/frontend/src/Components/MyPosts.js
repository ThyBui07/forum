...
const post = [
  {id: 1, authorId: 1, title: "Daim Frozen Cake", content: "Base: Mix Digestive Biscuits with Butter, Middle: Creme Fraiche, whipped cream and caramel sauce, Top: sprinkle cut daim bars", Date: "01 June 2022", CategoryID: "dessert" },
  {id: 2, authorId: 2, title: "Sunny side up egg", content: "Crack an egg on a pan over medium heat", Date: "02 June 2022", CategoryID: "appetizer" },
...
// all of user's posts
const userPosts = post.filter(post => post.authorId == loggedinUser.id)
